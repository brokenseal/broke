...
(function(){
   ...
   * a class has been created, but before [broke.Class.static.extended|extended] is called on its base class.  
   ...
   * 
   * 
   * @init Creating a new instance of an object that has extended broke.Class 
  ...
  broke.Class.
     ...
     * @codestart
     * broke.Class.extend("MyOrg.MyClass",{},{})
     * MyOrg.MyClass.className //-> 'MyClass'
     * MyOrg.MyClass.fullName //->  'MyOrg.MyClass'
     * @codeend
     */
     ...
     * [broke.Class.static.extended|extended] is called on the inheriting class.  "init" is a great place to put a class's setup code.
     * @param {broke.Class} class the new class
     */
  ...
  broke.Class.prototype = {
      /**
       * @function callback
       * Returns a callback function.  This does the same thing as and is described better in [broke.Class.static.callback].
