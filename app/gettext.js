	...
	broke.Class.extend("broke.i18n.Gettext", {
		...
		tryLoadLang: function() {
			...
			if (typeof(this.localeData) != 'undefined') {
			    ...
			    var locale_copy = this.localeData;
			    this.localeData = undefined;
			    this.parseLocaleData(locale_copy);
			...
			// get lang links
			var lang_link = this.getLangRefs();
		...
		parseLocaleData: function(localeData) {
			...
			for (var domain in localeData) {
			    ...
			    for (var msgid in localeData[domain]) {
			        has_msgids = true;
			        break;
			    }
